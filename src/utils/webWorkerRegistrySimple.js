/**
 * Simple Web Worker Registry
 * 
 * This module provides a simplified web worker registry that works
...
class SimpleWorkerRegistry {
  ...
  terminateWorker(workerType) {
    ...
    console.log(`Terminating worker ${workerType} (no-op in simple implementation)`);
  }
  ...
  terminateAllWorkers() {
    // No-op in this simple implementation
    console.log('Terminating all workers (no-op in simple implementation)');
  }
}
