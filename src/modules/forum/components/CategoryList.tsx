...
/**
 * Component to display a list of forum categories
 */
const CategoryList: React.FC<CategoryListProps> = ({ 
  ...
  const getCategoryIcon = (category: ForumCategory) => {
    const iconName = category.icon_name || category.type;
      ...
      <div className={`bg-white shadow overflow-hidden sm:rounded-md ${className}`}>
        <div className="px-4 py-5 sm:p-6 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Check back later for forum categories.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className={`bg-white shadow overflow-hidden sm:rounded-lg ${className}`}>
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">Forum Categories</h3>
      ...
      <div className="border-t border-gray-200">
        <ul className="divide-y divide-gray-200">
          {categories.map((category) => (
            <li key={category.id}>
              <Link to={`/forum/category/${category.slug}`} className="block hover:bg-gray-50">
