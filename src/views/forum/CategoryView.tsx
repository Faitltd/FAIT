...
import ThreadList from '../../modules/forum/components/ThreadList';

/**
 * View for a forum category
 */
const CategoryView: React.FC = () => {
  const { slug } = useParams<{ slug: string }>();
  const navigate = useNavigate();
  const { getCategoryBySlug, getThreadsByCategory } = useForum();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Get threads
        const threadsData = await getThreadsByCategory(categoryData.id, page, limit);
