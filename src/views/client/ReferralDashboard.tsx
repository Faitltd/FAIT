...
/**
 * Dashboard for client referrals
 */
      ...
      <div className="py-10">
        <header>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold leading-tight text-gray-900">Referral Program</h1>
          </div>
        </header>
        <main>
            ...
            <div className="px-4 py-6 sm:px-0">
              <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6">
                  <h2 className="text-lg leading-6 font-medium text-gray-900">Refer Friends & Earn Rewards</h2>
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">
                    Invite friends to join FAIT Co-op and earn rewards when they sign up and complete verification.
                  </p>
                </div>
                        ...
                        <ol className="list-decimal pl-5 space-y-2">
                          ...
                          <li>
                            ...
                            <span className="font-medium text-blue-600">
                              {referralProgram?.client_reward_amount || 100} points
                            </span>
                          </li>
                          <li>They'll also receive a welcome bonus of {referralProgram?.referred_client_reward_amount || 50} points</li>
                        </ol>
                      </div>
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3 flex-1 md:flex md:justify-between">
                            <p className="text-sm text-blue-700">
                              Service agents earn {referralProgram?.service_agent_reward_amount || 200} points for each verified service agent they refer.
                            </p>
                          </div>
                        </div>
                      </div>
