...
const ServiceAgentDashboardFixed: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
        <a href="/dashboard/service-agent/messages" className="block">
        ...
        <a href="/dashboard/service-agent/jobs" className="block">
          <div className="bg-white rounded-lg shadow-sm p-6 h-full hover:shadow-md transition-shadow">
            <div className="flex items-center">
        ...
        <a href="/dashboard/service-agent/listings" className="block">
          <div className="bg-white rounded-lg shadow-sm p-6 h-full hover:shadow-md transition-shadow">
            <div className="flex items-center">
