...
import ServiceAgentDashboardFixed from './ServiceAgentDashboardFixed.jsx';
...
const ServiceAgentDashboardWrapper = () => {
  ...
  // Monkey patch the supabase client to make it available in the ServiceAgentDashboard
  ...
  return (
    <AuthContext.Provider value={authContextValue}>
      <ServiceAgentDashboardFixed />
    </AuthContext.Provider>
  );
};

export default ServiceAgentDashboardWrapper;
