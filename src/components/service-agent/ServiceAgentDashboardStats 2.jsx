...
// Displays key statistics for the service agent dashboard

const ServiceAgentDashboardStats = ({ stats }) => {
  if (!stats) {
    return null;
  }

  const { service_stats, booking_stats, warranty_stats, subscription_plan } = stats;
                  ...
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      ...
                      <div className="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                        ...
                        {service_stats.active_services} active
                      </div>
                    </dd>
                  </dl>
                </div>
                  ...
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      ...
                      <div className="ml-2 flex items-baseline text-sm font-semibold text-yellow-600">
                        ...
                        {booking_stats.pending_bookings} pending
                      </div>
                    </dd>
                  </dl>
                </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      <div className="text-2xl font-semibold text-gray-900">
                        {service_stats.average_rating.toFixed(1)}
                      </div>
                      <div className="ml-2 flex items-baseline text-sm font-semibold">
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg
                              key={star}
                              className={`h-4 w-4 ${star <= Math.round(service_stats.average_rating) ? 'text-yellow-400' : 'text-gray-300'}`}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      <div className="text-2xl font-semibold text-gray-900">
                        ${booking_stats.total_revenue.toFixed(2)}
                      </div>
                    </dd>
                  </dl>
                </div>
...
export default ServiceAgentDashboardStats;