...
// Card component showing service list

const ServiceListCard = ({ services }) => {
              ...
              {services.map((service) => (
                <tr key={service.id}>
                      ...
                      {service.average_rating && (
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg
                              key={star}
                              className={`h-4 w-4 ${star <= Math.round(service.average_rating) ? 'text-yellow-400' : 'text-gray-300'}`}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link to={`/services/${service.id}/edit`} className="text-blue-600 hover:text-blue-900 mr-4">
                      Edit
                    </Link>
                    <Link to={`/services/${service.id}`} className="text-blue-600 hover:text-blue-900">
                      View
                    </Link>
                  </td>
                </tr>
