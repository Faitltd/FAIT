...
const LocationStep: React.FC<LocationStepProps> = ({ 
  ...
  const [locationType, setLocationType] = useState<'home' | 'work' | 'other'>(
    bookingData.location.type || 'home'
  );
  ...
  }, [address, city, state, zip, locationType, updateBookingData]);
  ...
  const handleSelectLocation = (location: any) => {
    ...
    setZip(location.zip);
    setLocationType(location.type as 'home' | 'work' | 'other');
    setErrors({});
  };
