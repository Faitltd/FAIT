...
const Footer: React.FC = () => {
  ...
  return (
    <footer style={{ backgroundColor: '#c0e2ff' }} className="border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-gray-900">FAIT Co-Op</h3>
            <p className="mt-2 text-sm text-gray-600">
              Connecting homeowners with skilled service agents for all your home improvement and maintenance needs.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/services/search" className="text-base text-gray-500 hover:text-gray-900">
                  Search Services
                </Link>
              </li>
              <li>
                <Link to="/subscription/plans" className="text-base text-gray-500 hover:text-gray-900">
                  Subscription Plans
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/user-guide" className="text-base text-gray-500 hover:text-gray-900">
                  User Guide
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <Link to="/terms-of-service" className="text-sm text-gray-400 hover:text-gray-500">
              Terms
            </Link>
            <Link to="/privacy-policy" className="text-sm text-gray-400 hover:text-gray-500">
              Privacy
            </Link>
            <Link to="/cookie-policy" className="text-sm text-gray-400 hover:text-gray-500">
              Cookies
            </Link>
          </div>
          <p className="mt-8 text-sm text-gray-400 md:mt-0 md:order-1">
            &copy; {currentYear} FAIT Co-Op. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
