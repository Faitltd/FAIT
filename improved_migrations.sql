...
-- Create service_agent_work_history table if it doesn't exist
...
-- Create trigger for updating updated_at
DROP TRIGGER IF EXISTS update_service_agent_work_history_updated_at ON service_agent_work_history;
...
-- Create service_agent_references table if it doesn't exist
...
-- Create trigger for updating updated_at
DROP TRIGGER IF EXISTS update_service_agent_references_updated_at ON service_agent_references;
...
-- Create service_agent_portfolio_items table if it doesn't exist
...
-- Create trigger for updating updated_at
DROP TRIGGER IF EXISTS update_service_agent_portfolio_items_updated_at ON service_agent_portfolio_items;
