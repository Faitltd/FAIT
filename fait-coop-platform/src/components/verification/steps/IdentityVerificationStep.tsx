...
const IdentityVerificationStep: React.FC<IdentityVerificationStepProps> = ({ onUpload, loading }) => {
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-6">
        Please upload a clear photo or scan of a government-issued ID (driver's license, passport, or state ID).
      </p>
