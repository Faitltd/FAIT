		...
		<div class="bg-white rounded-2xl shadow-xl p-8">
			...
			<form on:submit|preventDefault={handleSubmit} class="space-y-6">
				...
				<button
					...
					class="btn btn-primary w-full text-lg py-3 hover-scale {isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}"
				>
			...
			<div class="mt-6 grid grid-cols-2 gap-3">
				<button
					...
					class="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-all hover-scale"
				>
