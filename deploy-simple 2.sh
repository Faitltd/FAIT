...
gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars SUPABASE_URL=$VITE_SUPABASE_URL,SUPABASE_ANON_KEY=$VITE_SUPABASE_ANON_KEY,SUPABASE_SERVICE_KEY=$SUPABASE_SERVICE_KEY,SUPABASE_SERVICE_ROLE_KEY=$SUPABASE_SERVICE_ROLE_KEY,JWT_SECRET=$JWT_SECRET,VITE_GOOGLE_CLIENT_ID=$VITE_GOOGLE_CLIENT_ID,VITE_STRIPE_PUBLIC_KEY=$VITE_STRIPE_PUBLIC_KEY
