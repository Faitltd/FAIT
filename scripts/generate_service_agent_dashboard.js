...
// Configuration for the service agent dashboard components
const config = {
  componentsDir: 'src/components/service-agent',
  pagesDir: 'src/pages/dashboard',
  components: [
    {
      name: 'ServiceAgentDashboardStats',
      description: 'Displays key statistics for the service agent dashboard'
    },
    {
      name: 'ServiceListCard',
      description: 'Card component showing service list'
    },
    {
      name: 'UpcomingAppointmentsCard',
      description: 'Card component showing upcoming appointments'
    },
    {
      name: 'BookingRequestsCard',
      description: 'Card component showing booking requests'
    },
    {
      name: 'RecentClientsCard',
      description: 'Card component showing recent clients'
    },
    {
      name: 'WarrantyStatusCard',
      description: 'Card component showing warranty status'
    }
  ],
  pages: [
    {
      name: 'ServiceAgentDashboard',
      description: 'Main service agent dashboard page'
    }
  ]
};
...
const generateServiceAgentDashboard = () => {
  console.log('Generating Service Agent Dashboard files...');
  generateComponents();
  generatePages();
  console.log('Service Agent Dashboard generation complete!');
};

// Execute the generator
generateServiceAgentDashboard();
