...
echo -e "${YELLOW}Building Docker image for Cloud Run using secure Dockerfile...${NC}"
docker build -t $IMAGE_NAME -f Dockerfile.cloudrun.secure \
...
echo -e "${YELLOW}Note: Environment variables are set directly in Cloud Run, not embedded in the Docker image.${NC}"

# Make the script executable
chmod +x deploy-to-cloudrun-secure.sh
